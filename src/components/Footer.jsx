    ...
    <footer className="bg-green-800 text-white py-12 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex max-w-md flex-col space-y-4">
              <div className="flex">
                ...
                <button
                  ...
                  className="bg-yellow-600 hover:bg-yellow-700 text-white px-4 rounded-r-md ml-3"
                >
                  <svg
              ...
              {showMessage && (
                <p className="text-white text-center">Thanks for subscribe</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <a className="hover:text-yellow-500" href="https://portfolio-eight-jade-39.vercel.app/">
            By: Eng- Mostafa Ismail Ibrahim
          </a>
        </div>
      </div>
    </footer>
